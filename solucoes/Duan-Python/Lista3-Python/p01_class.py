...
class Conta:
    ...
    def saque(self, valor):
        self.saldo -= valor
        print("Saque de",valor,"solicitado. Saldo atual:",self.saldo)
        return self.saldo
    def deposito(self, valor):
        self.saldo += valor
        print("Deposito de",valor,"realizado com sucesso. Saldo atual:",self.saldo)
        return self.saldo
...
class UsuarioPF(Usuario):
    cpf=""
    def __init__(self, nome, cpf):
        super().__init__(nome)  # atributo da classe mae usa super()
        self.cpf = cpf          # atributo da classe filha usa self
...
class ContaCorrente(Conta):
        def __init__(sel#           super.__init__(self, nome)      formato usado pelo Andref, saldo, cliente):
                super.__#           super.__init__(self, nome)      formato usado pelo Andreinit__(self, saldo, cliente)
class ContaPoupanca(Cont#           super.__init__(self, nome)      formato usado pelo Andrea):
        def __init__(sel#           super.__init__(self, nome)      formato usado pelo Andref, saldo, cliente):
                super.__#           super.__init__(self, nome)      formato usado pelo Andreinit__(self, saldo, cliente)
